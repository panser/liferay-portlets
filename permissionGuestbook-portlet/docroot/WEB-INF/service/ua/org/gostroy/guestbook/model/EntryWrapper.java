...
public class EntryWrapper implements Entry, ModelWrapper<Entry> {
	...
	*/
	...
	@Override
	public int compareTo(ua.org.gostroy.guestbook.model.Entry entry) {
	...
	@Override
	public com.liferay.portal.model.CacheModel<ua.org.gostroy.guestbook.model.Entry> toCacheModel() {
		return _entry.toCacheModel();
	}

	@Override
	public ua.org.gostroy.guestbook.model.Entry toEscapedModel() {
		return new EntryWrapper(_entry.toEscapedModel());
	}

	@Override
	public ua.org.gostroy.guestbook.model.Entry toUnescapedModel() {
