...
/**
 * Provides the local service interface for Guestbook3. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Sergey
 * @see Guestbook3LocalServiceUtil
...
public interface Guestbook3LocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Guestbook3LocalServiceUtil} to access the guestbook3 local service. Add custom service methods to {@link ua.org.gostroy.guestbook.service.impl.Guestbook3LocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
