...
<%
	...
	AssetEntry assetEntry = AssetEntryLocalServiceUtil.getEntry(Guestbook.class.getName(),
	...
	List<AssetTag> assetTags = AssetTagLocalServiceUtil.getTags(Guestbook.class.getName(),
			guestbook.getGuestbookId());
